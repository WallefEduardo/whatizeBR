...
export default function MembersTab({ members, users, departments }: Props) {
    ...
    <div className="bg-white dark:bg-dark-800 rounded border border-dark-200 dark:border-dark-700">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-dark-600 dark:text-dark-400 mt-1">
              Gerencie os atendentes do sistema e suas capacidades
            </p>
          </div>
      ...
      <div className="p-6">
        <Table
          ...
          emptyMessage="Nenhum membro encontrado. Adicione membros para começar a distribuir conversas."
        />
      </div>
